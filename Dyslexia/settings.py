...
DATABASES = {
    "default": dj_database_url.config(
        default="postgresql://postgres:KEKHvVyQKupUEBzWNqsFmQBFBmbNOetV@interchange.proxy.rlwy.net:44571/railway",
        conn_max_age=600,
        ssl_require=True,
    )
}
...
EMAIL_HOST_USER = os.environ.get("dyslexiacore@gmail.com")
EMAIL_HOST_PASSWORD = os.environ.get("yfndqozygwrbgnyg")
