...
ALLOWED_HOSTS = ['dyslexiacore-production.up.railway.app', 'https//:dyslexiacore-production.up.railway.app']
CSRF_TRUSTED_ORIGINS = ['dyslexiacore-production.up.railway.app', 'https//:dyslexiacore-production.up.railway.app']
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'Dyslexia_static_files')
]
STATIC_ROOT = os.path.join(BASE_DIR, 'Dyslexiafile')

STATICFILES_STORAGE = 'whitenoise.storage.CompressedManifestStaticFilesStorage'
STATIC_ROOT = BASE_DIR / 'staticfiles'

MEDIA_ROOT = os.path.join(BASE_DIR, 'site')
MEDIA_URL = '/site/'
